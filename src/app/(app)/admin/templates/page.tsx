...
import { createBeispiel1Template, deleteTemplate, newReportFromTemplate } from "@/lib/actions/templates";
              ...
              <tr key={t.id} className="border-b last:border-0">
                ...
                <td className="px-4 py-2 text-right">
                  <div className="flex justify-end gap-2">
                    <form action={newReportFromTemplate.bind(null, t.id)}>
                      <button className="rounded border px-2 py-0.5 text-xs text-gaba hover:bg-neutral-50">
                        Rapport erstellen
                      </button>
                    </form>
